...
public class BusConstants {
    ...
    public static final String BUS_ADDED_SUCCESSFULLY = "Bus Has Been Added Successfully";
    ...
    public static final String FIRST_NAME_LENGTH = "First name characters between min 4 and max 15";
    public static final String LAST_NAME_LENGTH = "Last name characters between min 4 and max 15";
